(function (global, factory) {
  ...
  describe('Global Header', function () {
    ...
    renderedComponent.render(_react2.default.createElement(_GlobalHeader2.default, null));
    ...
    describe('#logout', function () {
      it('allows a logout dropdown when clicking on profile avatar', function () {
        var profileAvatarElement = _ReactTestUtils2.default.findRenderedDOMComponentWithClass(header, 'profile-avatar');
        var profileAvatarButton = profileAvatarElement.children[0];
        _ReactTestUtils2.default.Simulate.click(profileAvatarButton);
        var dropDownElement = _ReactTestUtils2.default.findRenderedDOMComponentWithClass(header, 'c_dropdown');
        expect(dropDownElement.className).toBe('c_dropdown');
        var logoutButton = dropDownElement.children[0];
      ...
      it('hides a logout dropdown when clicking on profile avatar', function () {
        var profileAvatarElement = _ReactTestUtils2.default.findRenderedDOMComponentWithClass(header, 'profile-avatar');
        var profileAvatarButton = profileAvatarElement.children[0];
        _ReactTestUtils2.default.Simulate.blur(profileAvatarButton);
        var profileAvatarArray = _ReactTestUtils2.default.scryRenderedDOMComponentsWithClass(header, 'profile-avatar');
